...
(function($){
    ...
    BootstrapSelect.prototype.createSelect = function(){
    	...
    	$input.wrap('<span style="height:'+height+'px;border-radius:0px;border: 1px solid #ccc;display:block;overflow:hidden;width:'+width+'px;"></span>');
    	...
    	if($this.options.downBorder){
    		...
    		$('<a href="javascript:;" style="float:right;position:relative;display:inline-block;'
        			+'width:20px;height:'+(height)+'px;border-radius:0px;border:solid 1px #ccc;border-left:0;border-bottom-left-radius: 0; border-top-left-radius: 0;'
    ...
    BootstrapSelect.prototype.createDownList = function(data){
    	...
    	var style = 'display: none;'
    		...
    		+'border: 1px solid '+($this.options.downBorder?'#ccc;':'#ccc;')
