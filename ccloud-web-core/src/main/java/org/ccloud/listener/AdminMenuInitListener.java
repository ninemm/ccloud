...
public class AdminMenuInitListener implements MessageListener {
	...
	private MenuGroup createOrderMenuGroup() {
		...
		
		{
			...
			group.addMenuItem(new MenuItem("purchaseInstock", "/admin/purchaseInstock", "采购入库单"));
			group.addMenuItem(new MenuItem("purchaseRefundOutstock", "/admin/purchaseRefundOutstock", "采购退货单"));
		}
