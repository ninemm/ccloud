...
@Listener(action = Actions.STATION_ADD)
public class StationAddListener implements MessageListener {
	...
	public void onMessage(Message message) {
		...
		if (temp != null && temp instanceof JModel) {
			...
			if (parentStation.getIsParent() == null || parentStation.getIsParent() == 0) {
				parentStation.setIsParent(1);
