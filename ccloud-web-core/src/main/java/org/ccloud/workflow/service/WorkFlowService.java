package org.ccloud.workflow.service;
...
public class WorkFlowService {
	...
	private static final WorkFlowService me = new WorkFlowService();

	public static WorkFlowService me() {
		return me;
	}
	...
	public String updateState(String state, String procDefId) {
		if (state.equals("active")) {
			ActivitiPlugin.buildProcessEngine().getRepositoryService().activateProcessDefinitionById(procDefId, true,
					null);
			return "激活成功";
		} else if (state.equals("suspend")) {
			ActivitiPlugin.buildProcessEngine().getRepositoryService().suspendProcessDefinitionById(procDefId, true,
					null);
			return "挂起成功";
		}
		return "无操作";
	...
	@Before(Tx.class)
	public void claim(String candidateUser) {
		List<Task> list = ActivitiPlugin.buildProcessEngine().getTaskService().createTaskQuery()
