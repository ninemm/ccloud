...
@RouterMapping(url = "/admin/process-instance/highlights")
public class ProcessInstanceHighlightsResourceController extends Controller {
	
	private ProcessEngine pEngine = ActivitiPlugin.buildProcessEngine();

	private RuntimeService runtimeService = pEngine.getRuntimeService();

	private RepositoryService repositoryService = pEngine.getRepositoryService();

	private HistoryService historyService = pEngine.getHistoryService();
