 ...
 */
@RouterMapping(url = "/admin/modelEditor/json")
public class ModelEditorJsonRestResourceController extends Controller implements ModelDataJsonConstants {

	protected static final Logger LOGGER = LoggerFactory.getLogger(ModelEditorJsonRestResourceController.class);

	private ObjectMapper objectMapper = new ObjectMapper();

	// @RequestMapping(value="/model/{modelId}/json", method =
