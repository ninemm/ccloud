...
public class PurchaseInstockQuery extends JBaseQuery { 
	...
	public Page<PurchaseInstock> paginate(int pageNumber, int pageSize, String orderby) {
		String select = "select * ";
		StringBuilder fromBuilder = new StringBuilder("from `cc_purchase_instock` ");
	...
	public int findByUserId(String userId){
		String sql = "select * from cc_purchase_instock where input_user_id ='"+userId+"'";
