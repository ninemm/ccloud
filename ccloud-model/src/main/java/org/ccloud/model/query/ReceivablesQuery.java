...
public class ReceivablesQuery extends JBaseQuery { 
	...
	public Page<Record> paginate(int pageNumber, int pageSize, String id,String seller_id,String dataArea,String sellerId,String keyword, String startDate, String endDate) {
		...
		select = " SELECT r.object_id AS id, t1.customerTypeNames, c.customer_name AS name, sum(rd.receive_amount) receive_amount , (IFNULL(r.act_amount, 0)) act_amount , (IFNULL(sum(rd.receive_amount) , 0) - IFNULL(r.act_amount, 0)) balance_amount  ";
