...
public class ProductCompositionQuery extends JBaseQuery { 
	...
	public List<Record> findDetailByProductId(String id, String sellerId, String keyword, String tag) {
 		StringBuilder fromBuilder = new StringBuilder("SELECT aa.title as activity_name,cp.id,cp.name,cp.price,cp.seller_product_id,cp.sub_seller_product_id,cs.product_id as product_id,cg.product_id as sub_product_id, ");
