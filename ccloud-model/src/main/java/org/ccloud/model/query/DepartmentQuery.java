...
//		sql.append(" WHERE d2.parent_id > '0'");
	...
	public List<Record> findDataArea() {
		String sql="SELECT d.id , d.dept_name , d.data_area FROM department d WHERE d.dept_level = 1 ";
		return Db.find(sql);
	}

	public List<Record> findByDataAreaSeller(String dataArea) {
		String sql="SELECT d.id , d.dept_name , d.data_area,d.qywx_deptid FROM department d WHERE d.dept_level IN(1 , 2) and ";
		sql=sql+"d.data_area LIKE '"+dataArea+"%' ORDER BY d.dept_level";
		return Db.find(sql);
	}
