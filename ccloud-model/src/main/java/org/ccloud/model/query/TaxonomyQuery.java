...
public class TaxonomyQuery extends JBaseQuery {
	...
	public Taxonomy findById(final String id) {
	...
	public List<Taxonomy> findListCategoryByContentId(String contentId) {
		return findListByTypeAndContentId(Taxonomy.TYPE_CATEGORY, contentId);
	}

	public List<Taxonomy> findListTagByContentId(String contentId) {
		return findListByTypeAndContentId(Taxonomy.TYPE_TAG, contentId);
	}
	
	public List<Taxonomy> findListByParentId(String parentId) {
	...
	public List<Taxonomy> findListByTypeAndContentId(String type, String contentId) {
