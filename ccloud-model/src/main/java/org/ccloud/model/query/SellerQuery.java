...
*/		if(StrKit.notBlank(sellerId)) {
	...
	public List<Record> findDeptByLevel(){
		StringBuilder sql = new StringBuilder("SELECT d.data_area id,d.dept_name text from department d LEFT JOIN cc_seller cs ON cs.dept_id = d.id WHERE d.dept_level IN(1 , 2) AND d.qywx_deptid is NOT NULL");
