...
public class ActivityQuery extends JBaseQuery {
	...
	public Record findYxActivity(String activityApplyId) {
		StringBuilder fromBuilder = new StringBuilder("SELECT cc.id customerId,caa.apply_area WriteOffSize,ccv.check_size ExecuteSize , ced.item1 ChannelID , ced.item2 ShowType , ca.invest_type , ca.proc_code 'FlowIDNO', ca.proc_id 'FlowID',( SELECT qb.FeeTypeID FROM dict d LEFT JOIN qy_basicfeetype qb ");
