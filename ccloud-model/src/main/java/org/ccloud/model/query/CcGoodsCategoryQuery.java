 ...
 */
public class CcGoodsCategoryQuery extends JBaseQuery { 

	protected static final CcGoodsCategory DAO = new CcGoodsCategory();
	private static final CcGoodsCategoryQuery QUERY = new CcGoodsCategoryQuery();

	public static CcGoodsCategoryQuery me() {
		return QUERY;
	}

	public CcGoodsCategory findById(final String id) {
	...
	public Page<CcGoodsCategory> paginate(int pageNumber, int pageSize, String parentId, String keyword, String orderby) {
	...
	public List<Map<String, Object>> findCategoryListAsTree(int i) {
		List<CcGoodsCategory> list = findCategoryList(null,"order_list asc");
	...
	public List<CcGoodsCategory> findCategoryList(String parentId, String orderby) {
		...
		List<CcGoodsCategory> data = DAO.getFromListCache(key, new IDataLoader() {
		...
		if (data == null)
			return null;
		return new ArrayList<CcGoodsCategory>(data);
	}	
	...
	private List<Map<String, Object>> doBuild(List<CcGoodsCategory> list) {
		List<Map<String, Object>> resTreeList = new ArrayList<>();
		for(CcGoodsCategory category : list) {
			Map<String, Object> map = new HashMap<>();
	...
	public List<CcGoodsCategory> findByParentId(String id) {
	...
	public List<CcGoodsCategory> findCategoryByBrandId(String id) {
