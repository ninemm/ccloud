...
public class SalesOrderDetailQuery extends JBaseQuery {
	...
	public List<Record> findByOrderId(String orderId) {
		...
		StringBuilder sqlBuilder = new StringBuilder(
				" SELECT sod.*,sp.seller_id, sp.custom_name, sp.price,sp.bar_code, p.big_unit, p.small_unit, p.convert_relate, p.id as productId, p.product_sn, g.product_image_list_store, w.code as warehouseCode, t1.valueName,w.name as warehouseName ");
