 ...
 */
public class CcCustomerQuery extends JBaseQuery {

	protected static final CcCustomer DAO = new CcCustomer();
	private static final CcCustomerQuery QUERY = new CcCustomerQuery();

	public static CcCustomerQuery me() {
		return QUERY;
	}
	...
	public boolean enable(String id, int isEnabled) {
		CcCustomer ccCustomer = DAO.findById(id);
		ccCustomer.set("is_enabled", isEnabled);

		return ccCustomer.saveOrUpdate();
	}

	public CcCustomer findById(final String id) {
