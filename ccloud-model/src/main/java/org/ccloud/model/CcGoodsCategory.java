...
import org.ccloud.model.base.BaseCcGoodsCategory;

/**
 * Generated by 九毫米(http://9mm.tech).
 */
@Table(tableName="cc_goods_category",primaryKey="id")
public class CcGoodsCategory extends BaseCcGoodsCategory<CcGoodsCategory> implements ISortModel<CcGoodsCategory>{

	private static final long serialVersionUID = 1L;

    private int layer = 0;
    private CcGoodsCategory parent;
    private List<CcGoodsCategory> childList;
    ...
    public void setParent(CcGoodsCategory parent) {
        this.parent = parent;
    }

    public CcGoodsCategory getParent() {
        return parent;
    }


    public void addChild(CcGoodsCategory child) {
    ...
    public List<CcGoodsCategory> getChildList() {
        return this.childList;
    }

    public void setChildList(List<CcGoodsCategory> childList) {
