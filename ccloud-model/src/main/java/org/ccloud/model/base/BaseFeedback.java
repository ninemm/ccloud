...
public abstract class BaseFeedback<M extends BaseFeedback<M>> extends JModel<M> implements IBean {

	public static final String CACHE_NAME = "cc_feedback";
	public static final String METADATA_TYPE = "cc_feedback";

	public static final String ACTION_ADD = "cc_feedback:add";
	public static final String ACTION_DELETE = "cc_feedback:delete";
	public static final String ACTION_UPDATE = "cc_feedback:update";
