...
public abstract class BaseCustomerVisit<M extends BaseCustomerVisit<M>> extends JModel<M> implements IBean {
	...
	public void setRLng(java.math.BigDecimal rLng) {
		set("r_lng", rLng);
	}

	public java.math.BigDecimal getRLng() {
		return get("r_lng");
	}

	public void setRLat(java.math.BigDecimal rLat) {
		set("r_lat", rLat);
	}

	public java.math.BigDecimal getRLat() {
		return get("r_lat");
	}
