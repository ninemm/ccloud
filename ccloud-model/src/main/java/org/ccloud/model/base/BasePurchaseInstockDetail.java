...
public abstract class BasePurchaseInstockDetail<M extends BasePurchaseInstockDetail<M>> extends JModel<M> implements IBean {

	public static final String CACHE_NAME = "cc_purchase_instock_detail";
	public static final String METADATA_TYPE = "cc_purchase_instock_detail";

	public static final String ACTION_ADD = "cc_purchase_instock_detail:add";
	public static final String ACTION_DELETE = "cc_purchase_instock_detail:delete";
	public static final String ACTION_UPDATE = "cc_purchase_instock_detail:update";
	...
	public boolean equals(Object o) {
		...
		if(!(o instanceof BasePurchaseInstockDetail<?>)){return false;}

		BasePurchaseInstockDetail<?> m = (BasePurchaseInstockDetail<?>) o;
	...
	public void setPurchaseInstockId(java.lang.String purchaseInstockId) {
		set("purchase_instock_id", purchaseInstockId);
	}

	public java.lang.String getPurchaseInstockId() {
	...
	public void setPurchaseOrderDetailId(java.lang.String purchaseOrderDetailId) {
		set("purchase_order_detail_id", purchaseOrderDetailId);
	}

	public java.lang.String getPurchaseOrderDetailId() {
		return getStr("purchase_order_detail_id");
	}
