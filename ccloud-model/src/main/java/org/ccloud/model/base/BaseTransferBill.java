...
public abstract class BaseTransferBill<M extends BaseTransferBill<M>> extends JModel<M> implements IBean {

	public static final String CACHE_NAME = "cc_transfer_bill";
	public static final String METADATA_TYPE = "cc_transfer_bill";

	public static final String ACTION_ADD = "cc_transfer_bill:add";
	public static final String ACTION_DELETE = "cc_transfer_bill:delete";
	public static final String ACTION_UPDATE = "cc_transfer_bill:update";
	...
	public boolean equals(Object o) {
		...
		if(!(o instanceof BaseTransferBill<?>)){return false;}

		BaseTransferBill<?> m = (BaseTransferBill<?>) o;
	...
	public void setTransferBillSn(java.lang.String transferBillSn) {
		set("transfer_bill_sn", transferBillSn);
	}

	public java.lang.String getTransferBillSn() {
	...
	public java.lang.String getFromWarehouseId() {
		return getStr("from_warehouse_id");
	}

	public void setToWarehouseId(java.lang.String toWarehouseId) {
		set("to_warehouse_id", toWarehouseId);
	}

	public java.lang.String getToWarehouseId() {
		return getStr("to_warehouse_id");
	}
