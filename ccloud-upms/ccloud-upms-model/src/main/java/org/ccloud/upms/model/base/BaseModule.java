...
public abstract class BaseModule<M extends BaseModule<M>> extends JModel<M> implements IBean {

	public static final String CACHE_NAME = "module";
	public static final String METADATA_TYPE = "module";

	public static final String ACTION_ADD = "module:add";
	public static final String ACTION_DELETE = "module:delete";
	public static final String ACTION_UPDATE = "module:update";
