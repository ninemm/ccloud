...
public class _CcBrandController extends JBaseCRUDController<CcBrand> { 
	...
	public void list() {
        ...
        Page<CcBrand> page = CcBrandQuery.me().paginate(getPageNumber(), getPageSize(), keyword, "create_date");
	...
	public void edit() {
		...
		if (id != null) {
			CcBrand ccBrand = CcBrandQuery.me().findById(id);
	...
	public void batchDelete() {
		...
		int count = CcBrandQuery.me().batchDelete(ids);
		if (count > 0) {
