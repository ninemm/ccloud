...
import model.query.MidIdnoQuery;
import org.ccloud.model.query.OptionQuery;
import model.query.QyBasicfeetypeQuery;
import model.query.QyBasicflowtypeQuery;
import model.query.QyBasicshowtypeQuery;
import model.query.QyExpensedetailQuery;
import org.ccloud.model.query.SalesOrderDetailQuery;
import org.ccloud.model.query.SalesOrderQuery;
import org.ccloud.model.query.SellerProductQuery;
import org.ccloud.model.query.SellerQuery;
import model.query.YxBasicchannelinfoQuery;
import model.query.YxBasicchanneltypeinfoQuery;
...
//	活动相关订单
	...
	private String SYN_INVES_PUBLICK(ActivityApply activityApply, Map<String, List<String>> ScenePhoto, 
		...
		try {
			HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_BRAND_INFO, map);
	...
	private String SYN_INVEST_CONSUMPTION_CULTIVATION(ActivityApply activityApply, Map<String, List<String>> ScenePhoto,
		...
		try {
			HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_PRODUCT_JUDGE, map);
			activityApply.setStatus(5);
			activityApply.update();
		} catch (Exception e) {
			e.printStackTrace();
	...
	private String SYN_INVEST_TERMINSL_ADVERTISWMENT(ActivityApply activityApply, Map<String, List<String>> ScenePhoto,
		...
		try {
			HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_SHOPAD_INFO, map);
			activityApply.setStatus(5);
			activityApply.update();
		} catch (Exception e) {
			e.printStackTrace();
	...
	private String SYN_INVEST_TERMINSL_DISPLAY(ActivityApply activityApply, Map<String, List<String>> ScenePhoto,
		...
		try {
			...
			HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_SHOPSHOW_INFO, map);
...
//					String photoId = StrKit.getRandomUUID();
				...
				HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_SHOPSHOW_INFO_DETAIL, detailMap);
			}
			activityApply.setStatus(5);
			activityApply.update();
		} catch (Exception e) {
	...
	private String SYN_INVEST_CUSTOMER_VISITE(ActivityApply activityApply, Map<String, List<String>> ScenePhoto,
		...
		try {
			HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_DISPLAY_INFO, map);
			activityApply.setStatus(5);
			activityApply.update();
		} catch (Exception e) {
			e.printStackTrace();
	...
	private String SYN_INVEST_SUPERMARKET_GIFT(ActivityApply activityApply,
		...
		try {
			HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_MARKET_GIFT_INFO, map);
			HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_MARKET_GIFT_EXECUTEINFO, executeMap);
			activityApply.setStatus(5);
			activityApply.update();
		} catch (Exception e) {
			e.printStackTrace();
	...
	private String SYN_INVEST_SLOTTING_FEE(ActivityApply activityApply, Map<String, List<String>> ScenePhoto,
		...
		try {
			HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_ENTRY_COSTINFO, map);
			HttpUtils.post(MidDataUtil.POST_JINGPAI_ACTIVITY_ENTRY_COSTGIFTINFO, giftMap);
			activityApply.setStatus(5);
			activityApply.update();
		} catch (Exception e) {
			e.printStackTrace();
		...
		try {
			for (int i = 0; i < salesOrderDetail.size(); i++) {
				if (i == 0) {
					...
					HttpUtils.post(MidDataUtil.POST_JINGPAI_ORDER, orderMap);
				}
				Map<String, Object> orderDetailMap = ActivityMaps.orderDetailMap(orderId, salesOrderDetail.get(i));
				HttpUtils.post(MidDataUtil.POST_JINGPAI_ORDERDETAIL, orderDetailMap);				
			}
			return orderId;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Long addCustomer(String customerId) {
		...
		if (ShopID!=null) {
			...
			try {
				HttpUtils.post(MidDataUtil.POST_JINGPAI_SHOPINFO, map);
	...
	public Map<String, List<String>> addPhoto(List<Record> listRecord) {
		...
		for (Record record : listRecord) {
			...
			for (int  a= 0; a <picList.size(); a++) {
				...
				try {
					HttpUtils.post(MidDataUtil.POST_JINGPAI_PHOTOINFO, map);
				} catch (Exception e) {
					e.printStackTrace();
					return null;
				}
