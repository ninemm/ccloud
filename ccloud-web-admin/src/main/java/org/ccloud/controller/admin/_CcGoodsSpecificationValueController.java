...
public class _CcGoodsSpecificationValueController extends JBaseCRUDController<CcGoodsSpecificationValue> { 
	private static final Log log = Log.getLog(_CcGoodsSpecificationValueController.class);
	...
	public void list() {
        ...
        Page<CcGoodsSpecificationValue> page = CcGoodsSpecificationValueQuery.me().paginate(getPageNumber(), getPageSize(), keyword, "order_list");
	...
	public void save() {
		...
		keepPara();
		final CcGoodsSpecificationValue ccGoodsSpecificationValue = getModel(CcGoodsSpecificationValue.class);
...
//			processImage(newPath);
	...
	public void edit() {
		...
		if (id != null) {
			CcGoodsSpecificationValue ccGoodsSpecificationValue = CcGoodsSpecificationValueQuery.me().findById(id);
			setAttr("ccGoodsSpecificationValue", ccGoodsSpecificationValue);
		}
		List<CcGoodsSpecification> list = CcGoodsSpecificationQuery.me().findAll();
		setAttr("list", list);
	}		
