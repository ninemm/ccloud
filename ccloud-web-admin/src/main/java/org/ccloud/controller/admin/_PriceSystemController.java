...
public class _PriceSystemController extends JBaseCRUDController<PriceSystem> {
	...
	public void list() {
		...
		Page<PriceSystem> page = PriceSystemQuery.me().paginate(getPageNumber(), getPageSize(), keyword, "create_date",
				user.getDepartmentId(), user.getDataArea(), SecurityUtils.getSubject().hasRole("/admin/all"));
	...
	public void save() {
		...
		if (SecurityUtils.getSubject().hasRole("/admin/all")) {
			...
			String dataArea = DepartmentQuery.me().findById(user.getDepartmentId()).get("data_area");
			priceSystem.set("data_area", dataArea);
		}
