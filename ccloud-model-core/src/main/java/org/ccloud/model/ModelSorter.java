...
public class ModelSorter {
	...
	public static <M extends ISortModel> void sort(List<M> tlist, String parentId) {
		if (tlist == null)
			return;
	...
	public static <M extends ISortModel> void sort(List<M> tlist, List<M> newlist, String parentId, int layer) {
		for (M model : tlist) {
			if (parentId == null) {
				if (model.getParentId() == null || model.getParentId().compareTo(String.valueOf(BigInteger.ZERO)) <= 0) {
	...
	public static <M extends ISortModel> void removeTreeBranch(List<M> treelist, String branchId) {
